...
<body>
    <!-- navbar -->
    <nav id="nav" class="fixed text-black shadow-xl z-50 w-full mb-20 px-7 py-2 flex justify-between font-bold tracking-wide rounded-b-2xl items-center" style="backdrop-filter: blur(3px);">
        <img class="block h-8 w-auto float-left" src="assets/KOMASI2.svg" alt="Image">
        <div>
            <a href="index.php" class="hover:text-[#2B9871] hover:underline decoration-2 px-3 py-1">Beranda</a>
            <span class="dropdown"><a href="#" class="dropbtn  hover:text-[#2B9871] hover:underline decoration-2">About<i class="fas fa-angle-down" style="margin-left: 5px;"></i></a>
                <div class="drop">
                    <a href="about2.php">Komasi</a>
                    <a href="about2.php#section4">Visi & Misi</a>
                    <a href="bph.php">Struktur Organisasi</a>
                </div>
            </span>
            <a href="index.php#section3" class="hover:text-[#2B9871] hover:underline decoration-2 px-3 py-1">Sharmasi</a>
